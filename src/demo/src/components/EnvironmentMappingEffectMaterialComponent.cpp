...
namespace demo
{
	...
	EnvironmentMappingEffectMaterialComponent::EnvironmentMappingEffectMaterialComponent(const Application& app)
		: SceneComponent(app)
	...
	EnvironmentMappingEffectMaterialComponent::~EnvironmentMappingEffectMaterialComponent() = default;

	void EnvironmentMappingEffectMaterialComponent::Initialize()
	{
		m_effect = Effect::Create(m_app, k_effectPath);
		m_effect->LoadCompiled();

		m_material = std::make_unique<EnvironmentMappingEffectMaterial>(*m_effect);
	...
	void EnvironmentMappingEffectMaterialComponent::Update(const Time& time)
	{
		if (!!m_keyboard)
		{
	...
	void EnvironmentMappingEffectMaterialComponent::SetEffectData()
	{

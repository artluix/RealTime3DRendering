...
namespace demo
{
	...
	void DisplacementMappingComponent::Update(const Time& time)
	{
	...
	void DisplacementMappingComponent::UpdateAmbientLight(const Time& time)
	{
	...
	void DisplacementMappingComponent::UpdatePointLight(const Time& time)
	{
	...
	void DisplacementMappingComponent::UpdateDisplacement(const library::Time& time)
	{
		if (!!m_keyboard)
		{
			const auto elapsedTime = time.elapsed.GetSeconds();

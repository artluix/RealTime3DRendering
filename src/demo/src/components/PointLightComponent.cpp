...
namespace demo
{
	...
	void PointLightComponent::Initialize(const Application& app)
	{
		assert(!!GetCamera());
	...
	void PointLightComponent::Update(const Time& time)
	{
	...
	void PointLightComponent::UpdateAmbientLight(const Time& time)
	{
	...
	void PointLightComponent::UpdatePointLight(const Time& time)
	{
	...
	void PointLightComponent::UpdateSpecularLight(const Time& time)
	{

...
namespace demo
{
	...
	DisplacementMappingEffectMaterialComponent::DisplacementMappingEffectMaterialComponent(const Application& app)
		: SceneComponent(app)
	...
	DisplacementMappingEffectMaterialComponent::~DisplacementMappingEffectMaterialComponent() = default;

	void DisplacementMappingEffectMaterialComponent::Initialize()
	{
		assert(!!m_camera);
		...
		m_material = std::make_unique<DisplacementMappingEffectMaterial>(*m_effect);
	...
	void DisplacementMappingEffectMaterialComponent::Update(const Time& time)
	{
	...
	void DisplacementMappingEffectMaterialComponent::UpdateAmbientLight(const Time& time)
	{
	...
	void DisplacementMappingEffectMaterialComponent::UpdatePointLight(const Time& time)
	{
	...
	void DisplacementMappingEffectMaterialComponent::UpdateDisplacement(const library::Time& time)
	{
		if (!!m_keyboard)
		{
			const auto elapsedTime = time.elapsed.GetSeconds();
	...
	void DisplacementMappingEffectMaterialComponent::SetEffectData()
	{

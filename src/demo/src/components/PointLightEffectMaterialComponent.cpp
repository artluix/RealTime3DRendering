...
namespace demo
{
	...
	PointLightEffectMaterialComponent::PointLightEffectMaterialComponent(const Application& app)
		: SceneComponent(app)
	...
	PointLightEffectMaterialComponent::~PointLightEffectMaterialComponent() = default;

	void PointLightEffectMaterialComponent::Initialize()
	{
		assert(!!m_camera);
		...
		m_material = std::make_unique<PointLightEffectMaterial>(*m_effect);
	...
	void PointLightEffectMaterialComponent::UpdateAmbientLight(const Time& time)
	{
	...
	void PointLightEffectMaterialComponent::UpdatePointLight(const Time& time)
	{
	...
	void PointLightEffectMaterialComponent::UpdateSpecularLight(const Time& time)
	{
	...
	void PointLightEffectMaterialComponent::SetEffectData()
	{

...
namespace demo
{
	...
	void FogComponent::Update(const Time& time)
	{
	...
	void FogComponent::UpdateAmbientLight(const Time& time)
	{
	...
	void FogComponent::UpdateDirectionalLight(const Time& time)
	{
	...
	void FogComponent::SetActiveTechnique()
	{
	...
	void FogComponent::SetEffectData()
	{

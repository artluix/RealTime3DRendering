...
namespace demo
{
	...
	void SpotlightComponent::Update(const Time& time)
	{
	...
	void SpotlightComponent::UpdateAmbientLight(const Time& time)
	{
	...
	void SpotlightComponent::UpdateSpotlight(const Time& time)
	{
	...
	void SpotlightComponent::UpdateSpecularLight(const Time& time)
	{

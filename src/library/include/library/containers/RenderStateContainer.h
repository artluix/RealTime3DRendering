...
namespace library
{
	...
	class RenderStateContainer : public NonConstructible<RenderStateContainer>
	{
	public:
		...
		static void ResetRenderState(const RenderState rs = RenderState::All);
		static void SaveRenderState(const RenderState rs = RenderState::All);
		static void RestoreRenderState(const RenderState rs = RenderState::All);

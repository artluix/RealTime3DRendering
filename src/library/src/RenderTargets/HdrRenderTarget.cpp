#include "StdAfx.h"
#include "library/RenderTargets/HdrRenderTarget.h"

#include "library/Application.h"

namespace library
{
HdrRenderTarget::HdrRenderTarget(const Application& app) : m_app(app)
{
	...
	// output texture & render target view
	{
		...
		fullScreenTextureDesc.Format = DXGI_FORMAT_R32G32B32A32_FLOAT;
		...
		// TODO: add SRV desc for mipmap generating
...
HdrRenderTarget::~HdrRenderTarget() = default;

//-------------------------------------------------------------------------

void HdrRenderTarget::Begin()
{
	RenderTarget::Begin(

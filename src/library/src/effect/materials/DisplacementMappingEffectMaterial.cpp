...
namespace library
{
	DisplacementMappingEffectMaterial::DisplacementMappingEffectMaterial(const Effect& effect)
	...
	DisplacementMappingEffectMaterial::~DisplacementMappingEffectMaterial() = default;

	void DisplacementMappingEffectMaterial::InitializeInternal()
	{
	...
	ComPtr<ID3D11Buffer> DisplacementMappingEffectMaterial::CreateVertexBuffer(ID3D11Device* const device, const Mesh& mesh) const
	{
		if (!mesh.HasVertices())

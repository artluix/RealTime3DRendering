    ...
    namespace components
    {
        ...
        void TriangleDemoComponent::Initialize()
        {
            ...
            // vertex buffer
            {
                ...
                std::array<vertex::PositionColor, 3> vertices =
                {
                    vertex::PositionColor(math::Vector4f(-l, -0.5f, 0.0f, 1.0f), Color(1.0f, 0.0f, 0.0f, 1.0f)), // left red
                    vertex::PositionColor(math::Vector4f(0.0f, 1.0f, 0.0f, 1.0f), Color(0.0f, 1.0f, 0.0f, 1.0f)), // up green
                    vertex::PositionColor(math::Vector4f(l, -0.5f, 0.0f, 1.0f), Color(0.0f, 0.0f, 1.0f, 1.0f)), // right blue
                };

                D3D11_BUFFER_DESC vertexBufferDesc{};
                vertexBufferDesc.Usage = D3D11_USAGE_IMMUTABLE;
                vertexBufferDesc.ByteWidth = sizeof(vertex::PositionColor) * vertices.size();
        ...
        {
            m_angle += DirectX::XM_PIDIV2 * time.elapsed.GetSeconds<float>();
            m_worldMatrix = math::Matrix4(DirectX::XMMatrixRotationZ(m_angle));
        }
